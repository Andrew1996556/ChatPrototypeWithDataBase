...
namespace Chat.DataBase {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class HistoryDataTable : global::System.Data.TypedTableBase<HistoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public HistoryRow AddHistoryRow(int Id, string UserName, string Message) {
        ...
        public partial class HistoryRow : global::System.Data.DataRow {
            ...
            public string Message {
                get {
                    return ((string)(this[this.tableHistory.MessageColumn]));
                }
                set {
                    this[this.tableHistory.MessageColumn] = value;
                }
            }
        }
...
namespace Chat.DataBase.DatabaseDataSetTableAdapters {
    ...
    public partial class HistoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[History] WHERE (([Id] = @Original_Id) AND ([UserName] = @Origi" +
                "nal_UserName))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[History] ([Id], [UserName], [Message]) VALUES (@Id, @UserName," +
                " @Message);\r\nSELECT Id, UserName, Message FROM History WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[History] SET [Id] = @Id, [UserName] = @UserName, [Message] = @Messa" +
                "ge WHERE (([Id] = @Original_Id) AND ([UserName] = @Original_UserName));\r\nSELECT " +
                "Id, UserName, Message FROM History WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Chat.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, UserName, Message FROM dbo.History";
        ...
        public virtual int Insert(int Id, string UserName, string Message) {
        ...
        public virtual int Update(int Id, string UserName, string Message, int Original_Id, string Original_UserName) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string UserName, string Message, int Original_Id, string Original_UserName) {
            return this.Update(Original_Id, UserName, Message, Original_Id, Original_UserName);
        }
    }
